...
leaf_object$.test_tscalar(tcor_des='f_temp_scalar_modArrhenius_des', Ha=40000 )
...
leaf_object$.test_solverFunc(verbose=F, verbose_loop=F, rs='f_rs_ball1987', leaf.ca_conc=300, leaf.par=100, sinput=seq(-2,2,0.02) ) 
